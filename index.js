...
bot.on('message', async (event) => {
  ...
  // if (event.message.type === 'text' && event.message.text === '山上天氣查詢') {
  //   try {
  //     // console.log(weather.contents[i].city)
  ...
  //               {
  //                 type: 'text',
  //                 text: `${weather.contents[i].district[num - 1]}`,
  //                 align: 'center',
  //                 color: '#4992B2'
  //               }
  //             ],
  ...
  //         ]
  //       }
  //       // city.contents.body.contents.push(district)
  //       console.log(city.contents.body.contents.push(district))
